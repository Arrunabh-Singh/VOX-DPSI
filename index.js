...
import timelineRoutes from './server/routes/timeline.js'
...
import auditLogRoutes from './server/routes/auditLog.js'
import workflowTemplateRoutes from './server/routes/workflowTemplates.js'
import resolutionTemplateRoutes from './server/routes/resolutionTemplates.js'
import delegationRoutes from './server/routes/delegations.js'
import safeDialogueRoutes from './server/routes/safeDialogue.js'
import guardianRoutes from './server/routes/guardian.js'
import configRoutes from './server/routes/config.js'
import { startAutoEscalateCron, startRetentionCron, startTermExpiryCron, startDailyDigestCron } from './server/jobs/autoEscalate.js'
...
app.get('/api/test-whatsapp', async (req, res) => {
  const { notifyAdminAlert } = await import('./server/services/notifications.js')
