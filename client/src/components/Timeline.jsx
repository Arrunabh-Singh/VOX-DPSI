          ...
          <div key={entry.id} className="flex gap-4">
            ...
            <div className="flex flex-col items-center">
              <div
                ...
                style={{ borderColor: colors.dot, backgroundColor: colors.dot }}
              />
            ...
            <div className={`pb-4 flex-1 ${isLast ? '' : ''}`}>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className="text-xs text-gray-500 whitespace-nowrap">{formatIST(entry.created_at)}</span>
                </div>
                {entry.performer && (
                ...
                {entry.note && (
                  <p className="text-sm text-gray-700 mt-1.5 italic">"{entry.note}"</p>
                )}
              </div>
            </div>
          </div>
