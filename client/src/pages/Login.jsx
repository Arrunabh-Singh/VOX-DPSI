  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '36px', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '13px', fontStyle: 'italic', margin: '0 0 16px 0', letterSpacing: '0.06em' }}>
          The Voice of Delhi Public School Indore
        </p>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', justifyContent: 'center' }}>
          <div style={{ height: '1px', width: '50px', background: `rgba(201,168,76,0.4)` }} />
          <span style={{ fontSize: '10px', color: 'rgba(201,168,76,0.7)', fontWeight: '700', letterSpacing: '0.15em', textTransform: 'uppercase' }}>Student Grievance System</span>
          <div style={{ height: '1px', width: '50px', background: `rgba(201,168,76,0.4)` }} />
        </div>
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          <h2 style={{ margin: '0 0 20px', fontSize: '18px', fontWeight: '700', color: '#1a1a1a' }}>
          ...
          <form onSubmit={doLogin} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            >
              {loading ? (
                <><span style={{ width: '16px', height: '16px', border: '2.5px solid #fff', borderTopColor: 'transparent', borderRadius: '50%', display: 'inline-block', animation: 'spin 0.7s linear infinite' }} /> Signing in...</>
              ) : 'Sign In →'}
            </button>
          </form>
        </div>
