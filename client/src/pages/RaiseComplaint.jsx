      ...
      <div className="min-h-screen" style={{ background: '#F0F4F8' }}>
        ...
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          <div className="glass-modal rounded-2xl p-10">
            ...
            <h2 className="text-2xl font-black mb-2" style={{ color: '#003366' }}>Complaint Submitted!</h2>
    ...
    <div className="min-h-screen" style={{ background: '#F0F4F8' }}>
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          >← Back</button>
          <div>
            <h1 className="text-2xl font-black" style={{ color: '#003366' }}>Raise a Complaint</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="glass rounded-2xl p-6">
            <label className="block text-sm font-bold mb-3" style={{ color: '#003366' }}>
          ...
          {/* Description */}
          <div className="glass rounded-2xl p-6">
            <label className="block text-sm font-bold mb-1" style={{ color: '#003366' }}>
          ...
          <div className="glass rounded-2xl p-6">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <p className="font-bold text-sm" style={{ color: '#003366' }}>Request Anonymity</p>
              ...
              <button
                ...
                style={{ background: isAnonymous ? '#003366' : '#D1D5DB' }}
              >
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg,#003366,#004080)', boxShadow: '0 8px 24px rgba(0,51,102,0.25)' }}
          >
            {loading ? (
