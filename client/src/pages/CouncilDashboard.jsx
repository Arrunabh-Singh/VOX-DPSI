...
const statCards = [
  { key: 'assigned',           label: 'Assigned',          color: '#003366', bg: '#EEF4FF' },
  ...
  { key: 'resolved',           label: 'Resolved',           color: '#16A34A', bg: '#EEF4FF' },
]
  ...
  return (
    <div className="min-h-screen" style={{ background: '#F0F4F8' }}>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-black" style={{ color: '#003366' }}>Council Dashboard</h1>
