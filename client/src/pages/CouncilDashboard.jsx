...
import { ConsensusVotingPanel } from '../components/ConsensusVotingPanel'
  ...
  return (
    <div className="min-h-screen" style={{ background: '#eae1c4' }}>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        {activeTab === 'agenda' && (
          <MeetingAgendaGenerator complaints={complaints} />
        )}
        {activeTab === 'delegation' && (
          <DelegationManager currentUser={user} />
        )}
        {activeTab === 'consensus' && (
          <ConsensusVotingPanel currentUserId={user?.id} />
        )}
      </main>
      <Footer />
    </div>
