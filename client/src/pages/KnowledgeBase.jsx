    ...
    items: [
      {
        ...
        answer: 'You can raise concerns about bullying, peer conflict, classroom issues, infrastructure, safety, school processes, staff conduct, or any situation where you need the council or school leadership to step in.',
      },
      {
        question: 'How detailed should my complaint be?',
        answer: 'Try to include what happened, where it happened, when it happened, who was involved, and what outcome would help. A clear timeline and specific details help the council understand what action is possible.',
      },
      {
        question: 'Can I attach proof or screenshots?',
        answer: 'Yes. If you have a relevant image, document, screenshot, or other file, you can attach it while raising the complaint. Only upload material that directly supports the issue.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Once submitted, the complaint becomes part of the official handling record. If you forgot an important detail, open the complaint and add a follow-up comment or speak to the assigned handler.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Access depends on the type of complaint and who needs to act on it. Student council handlers see complaints assigned to them, while serious or staff-related complaints may be routed to coordinators or senior school leadership.',
      },
      {
        question: 'Will the person I complain about see my name?',
        answer: 'Vox DPSI is designed to limit unnecessary disclosure. Your name should not be shared casually with the person named in the complaint, and the school should protect you as much as possible while resolving the issue.',
      },
      {
        question: 'Is my data kept forever?',
        answer: 'Complaint records are kept only as long as needed for school accountability, safety, and legal obligations. You can ask the school about access, correction, or erasure where applicable.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: 'Your complaint is registered with a complaint number and routed to the appropriate handler. The handler reviews the details, may ask follow-up questions, and records actions taken.',
      },
      {
        question: 'How long will it take to get a response?',
        answer: 'Most general complaints are expected to receive attention within the standard school handling window shown in Vox DPSI. Urgent or safety-related issues are prioritized faster.',
      },
      {
        question: 'What do the complaint statuses mean?',
        answer: 'Statuses show where your complaint is in the process. Open means it has been received, in progress means someone is working on it, resolved means an action or decision has been recorded, and escalated means a higher authority is handling it.',
      },
      {
        question: 'What if I am not satisfied with the resolution?',
        answer: 'If the issue is not resolved or the response does not address your concern, add a follow-up or use the available appeal or escalation options. Be specific about what still feels unresolved.',
      },
    ],
  },
]
